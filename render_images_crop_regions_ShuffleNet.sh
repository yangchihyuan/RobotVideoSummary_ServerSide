...
--save_to_directory=/4t/yangchihyuan/TransmittedImages/ShuffleNet/ \
--filelist_path=/4t/yangchihyuan/TransmittedImages/ShuffleNet/filelist/0503_lab_all.txt \
--mode=render_poses_crop_regions
