...
int main(int argc, char* argv[]) {
    try {
        ...
        //Chih-Yuan Yang: The pipeline object is used to compute the latency.
        ...
        while (keepRunning) {
            ...
            //Chih-Yuan Yang: the <models/results.h> describes the ResultBase struct.
            //pipeline.getResult() returns a std::unique_ptr<ResultBase> object.
            //The asRef() is a user-defined function in results.h, which is a dynamic_cast<>
